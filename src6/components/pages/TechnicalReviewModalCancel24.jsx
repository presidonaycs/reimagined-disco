...
class Tech24Cancel extends React.Component {
...
<FrankForm accept={this.onSubmit} show={this.state.passModal} handleClose={this.closePassModal} setSuccesss={this.onSuccess}/>
...
+
                ...
                <div>
                  <BooButton onClick={this.openPassModal}>Submit</BooButton>
