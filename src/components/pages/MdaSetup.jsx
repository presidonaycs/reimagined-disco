...
const MdaSetup = ({ history, details = {} }) => {
  ...
  return (
    <div className="w-100">
      ...
      <div className="w-100 flex space-between flex-v-center m-t-20">
        <h4 className="san-sherif">Create MDA</h4>
        <SearchInput placeholder="Search list..." />
      </div>
      <div className="table-view m-t-10">
        <div className="table-header">
          <div className="table-row">
            <div className="th"><p className="san-sherif">MDA List</p></div>
        ...
        <div className="table-body">
          {[{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }].map((item) => (
            <div className="table-row" key={item.id}>
              <div className="td">Ministry of Works and Housing</div>
      ...
      {showFormModal && <MdaForm closeModal={() => setShowFormModal(false)} />}
    </div>
  );
};
