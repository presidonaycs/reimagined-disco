...
const SupervisorOrganogram = ({ history, details = {} }) => {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = 'EDSG - Supervisory Organogram';
  }, []);
  ...
  return (
    <div className="w-100">
      ...
      <div className="w-100 flex space-between m-t-20 flex-v-center">
        <h4 className="san-sherif">Supervisory Organogram</h4>
      ...
      {showFormModal && <OrganogramForm closeModal={() => setShowFormModal(false)} />}
    </div>
  );
};
