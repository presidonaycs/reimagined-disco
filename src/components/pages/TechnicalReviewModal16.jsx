...
import { Container, Divider, Paper, TextField, withStyles } from '@material-ui/core';
...
class Tech16 extends React.Component {
 ...
 data = this.props.tech?.billofquantities?.map((it) => (
  {
    ...
    render() {
        ...
        if(this.props.show16){
          
        return (
            
        <div className="overlay">
        <IoMdClose className="close-btn pointer" onClick={this.props.handleClose16} />
      ...
      <Container style={{backgroundColor:'white', width:'70%'}}>
                {List.map((item) => (
        ...
        <div style={{display:'flex',justifyContent:'center'}}>
          ...
          <BooButton style={{backgroundColor:'silver', color:'black', width:'70%' }} onClick={this.props.handleClose16}>Close</BooButton>
