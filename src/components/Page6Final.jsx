                    ...
                    <div style={{ width: "33%", padding: "15px" }}>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Option value="Dashboard" key={1}>Dashboard</Option>
                                    <Option value="Request Maintainance" key={2}>Request Maintainance</Option>
                                    <Option value="Review Request" key={3}>Review Request</Option>
                                    <Option value="Manage Request" key={4}>Manage Request</Option>
                                    <Option value="Settings" key={5}>Settings</Option>
                                    <Option value="Report" key={6}>Report</Option>
                                </Select>
                            </Form.Item>
