                                ...
                                <div>
                                    <div className="">
                                        ...
                                        className="flex-between"
                                            ...
                                            <DatePicker  style={{width:"100%",border:"none",borderBottom: "1px solid", borderColor: "#D6D6D6" }} onChange={this.handleDate}/>
                                            </Form.Item>
                                        </Form>
                                     
                                    </div>

                    <TextArea rows={4} placeholder="Repair Details/Report" style={{ width: "100%", border:"none" }} onChange={e=>this.setState({details:e.target.value})}/>
                                </div>
