...
var key1 = 0;
class Page5F3 extends React.Component {
                        ...
                        >
                            ...
                            <Form.Item
                                ...
                                rules={[
                                    {
                                        required: true,
                                        message: 'Please input Remaining Quanntity!',
                                    },
                                ]}
                            >
                               
                                <Input readOnly style={{ border: "none", borderBottom: "1px solid", borderColor: "#D6D6D6" }} />
                            </Form.Item>
                            ...
                            <Form.Item
                                ...
                                rules={[
                                    {
                                        required: true,
                                        message: 'Please input Added Quanntity!',
                                    },
                                ]}
                            >
