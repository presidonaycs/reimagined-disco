...
class Page10F extends React.Component {
    ...
    approve = () =>{
      ...
      let bills =  this.state.newObject.map((item)=>(
            {id : 0,
      ...
      id: 0,
      requestid: this.props.row.requestID,
      details: this.props.row.details,
      addtionalcomment: this.props.row.subject,
      techReview: "this thing go chop money oh",
      createdAt: "2021-03-06T17:06:58.700Z",
      modifiedAt: "2021-03-06T17:06:58.700Z",
      createdBy: 0,
      modifiedBy: 0,
