...
class Page26 extends React.Component {
    ...
    handleAdd = () => {
        ...
        if (this.state.newObject != 0) {
            const newData = {
                key: count,
                title: this.state.newObject[0].title,
                sequence: this.state.newObject[0].sequence,
                lastUpdated: this.state.newObject[0].lastUpdated,
                quantity: this.state.newObject[0].updater,
    ...
    render() {
        ...
        return (
            ...
            <div className="page26 background">
                ...
                <div style={{ padding: "0px 0" }}>
                    <div style={{ padding: "10px", backgroundColor: "#D5FFD5", alignItems: "center", boxShadow: "0 2px 6px", display: "flex", color: "#43425D", justifyContent: "space-between" }}>
                        <h6 style={{ fontWeight: "bold", fontSize: "14px" }}>
                            Global Request Approval sequence
                    </h6>
                        <div>
                ...
                <div className="marginBottom" style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <div className="padding marginBottom border" style={{ backgroundColor: "white", }} >MDA approval request sequence</div>
                <div className="padding marginBottom border" style={{ backgroundColor: "white", }} >MDA approval request sequence</div>
                <div className="padding marginBottom border" style={{ backgroundColor: "white", }} >MDA approval request sequence</div>
                <div className="padding marginBottom border" style={{ backgroundColor: "white", }} >MDA approval request sequence</div>
            </div>
