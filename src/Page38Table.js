...
class Page38Table extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            dataSource: [
                ...
                //     key: '0',
                //     Item: 'Edward King 0',
                //     Threshold: 'London, Park La:ne no. 0',
                //     amount:'32',
                //     quantity:'32',
                // },
                // {
    ...
    handleAdd = () => {
        ...
        if (this.state.newObject != 0) {
            const newData = {
                key: count,
                item: this.state.newObject[0].item,
                threshold: this.state.newObject[0].threshold,
